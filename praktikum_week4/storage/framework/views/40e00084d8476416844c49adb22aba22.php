    ...
    <nav style="background-color: #7533F9;" class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        <div class="container py-2 px-4">
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src= "<?php echo e(Vite::asset('resources/images/logo-white.svg')); ?>"  alt="logo" style="width: 45px" />
            </a>
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <button class="dropdown-item active bg-purple" type="button"><small>Latest
                                                (5.3.x)<i class="bi-check"></i></small>
                                        </button>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <button class="dropdown-item" type="button"><small>All
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <button class="dropdown-item active bg-purple" type="button"><small><i
                                                    class="bi-brightness-high-fill me-2"></i>Light</small></button>
                                    </li>
                                    <li>
                                        <button class="dropdown-item" type="button"><small><i
                                                    class="bi-moon-stars-fill me-2"></i>Dark</small></button>
                                    </li>
                                    <li>
                                        <button class="dropdown-item" type="button"><small><i
                                                    class="bi-circle-half me-2"></i>Auto</small></button>
                                    </li>
                                </ul>
                            </div>
                        </li>
                    ...
                    <div class="row">
                        <div class="d-flex flex-column flex-md-row">
                            <button type="button" class="btn bg-purple text-white btn-lg mb-3 me-md-3 px-4 py-3"
                                style="background-color: #7533F9;">Get Started</button>
                            <button type="button"
                                class="btn btn-outline-dark btn-lg mb-3 px-4 py-3">Download</button>
                        </div>
                    </div>
                    <div class="text-muted">Currently <strong>v5.3.0-alpha2.</strong> · <a href="#">v4.6.x
                            docs</a> · <a href="#">All releases</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap to the next level with premium themes from the <a
                            href="#">official Bootstrap Themes marketplace</a>
                    ...
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">Browse Bootstrap
                        Themes<i class="bi bi-arrow-right mb-2"></i></a>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-6 col-lg-2 mb-5">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#">Corporatesponsors</a></li>
...
<?php /**PATH D:\File Kuliah\KULIAH SEMESTER 8\Pemrograman Framework\Week 4\Week 4\praktikum_week4\resources\views/bootstrap.blade.php ENDPATH**/ ?>